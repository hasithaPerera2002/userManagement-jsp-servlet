                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success"
                           data-toggle="modal"><span>Add New Supplier</span></a>
...
<script>
    $(document).ready(function () {
        $.ajax({
            url: "http://localhost:8080/userManagement/supplierController",
            type: "GET",
            dataType: "json",
            success: function (data) {
                ...
                if (data && data.length > 0) {
                    ...
                    $("#userTableBody").append("<tr><td colspan='7'>No suppliers found</td></tr>");
                }
            },
    ...
    function deleteUser(Id) {
        ...
        if (confirmDelete) {
            ...
            $.ajax({
                url: 'http://localhost:8080/userManagement/supplierController?id=' + Id,
                type: 'DELETE',
