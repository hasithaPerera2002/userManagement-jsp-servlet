                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success"
                           data-toggle="modal"><span>Add New Item</span></a>
...
<div id="addEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="itemManagementController" method="post">
...
<div id="editEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="itemManagementController">
                <div class="modal-header">
...
<script>
    $(document).ready(function () {
        $.ajax({
            url: "http://localhost:8080/userManagement/itemManagementController",
            type: "GET",
            dataType: "json",
    ...
    function deleteUser(Id) {
        ...
        if (confirmDelete) {
            ...
            $.ajax({
                url: 'http://localhost:8080/userManagement/itemManagementController?id=' + Id,
                type: 'DELETE',
